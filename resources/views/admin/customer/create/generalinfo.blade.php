                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-2 col-lg-12 col-md-4">
                                                            <div class="upload mt-4 pr-md-4">
                                                                 @if ($customer)
                                                                    <input type="file" id="input-file-max-fs" class="dropify" name="avatar" data-default-file="{{ asset('customerfiles/profilepicture')}}/{{$customer->avatar}}" data-max-file-size="2M" required/>
