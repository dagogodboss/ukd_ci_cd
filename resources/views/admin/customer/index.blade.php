                ...
                <div class="info">
                    ...
                    <form action="" method="GET">
                     ...
                     @if(can('Admin Loan Search'))
                      @include('admin.customer.admin-search')
                    @endif
                    @if(can('Branch Loan Search'))
                      @include('admin.customer.branch-search')
                    @endif
                    </form>
                </div>
            </div>
                                    ...
                                    <div class="item-content">
                                        ...
                                        <div class="action-btn">
                                             ...
                                             <div style="width:100%;" id="toggleAccordion">
                                                <div class="card">
                                                    <span class="badge badge-secondary" style="cursor:pointer;" id="headingOne1" data-toggle="collapse" data-target="#defaultAccordionOne" aria-expanded="false" aria-controls="defaultAccordionOne">
                                                         Loan List </span>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                     ...
                                                                     <tr>
                                                                        ...
                                                                        @endif
                                                                         <a class="badge badge-primary" href="{{url('loan/loan/showloan-detail',$loan->id)}}">View</a>
                                                                        </td>
                                                                        <td class="text-right">
                                                                            <!--<a class="badge badge-primary" href="{{url('loan/loan/showloan-detail',$loan->id)}}">View</a>-->
                                                                        </td>
