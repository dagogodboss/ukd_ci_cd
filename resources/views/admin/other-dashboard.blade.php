                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="add-edit-event-box">
                                        <div class="add-edit-event-content">
                                            <h5 class="add-event-title modal-title">Add Task</h5>
                                            ...
                                            <form class="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <label for="start-date" class="">Personal Task:</label>
                                                            ...
                                                            <div class="d-sm-flex d-block">
                                                                <div class="n-chk">
                                                                    <label class="new-control new-radio radio-primary">
                                                                      ...
                                                                      <span class="new-control-indicator"></span>Work Related
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="n-chk">
                                                                    <label class="new-control new-radio radio-warning">
                                                                      ...
                                                                      <span class="new-control-indicator"></span>Prospect
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="n-chk">
                                                                    <label class="new-control new-radio radio-danger">
                                                                      ...
                                                                      <span class="new-control-indicator"></span>Client
                                                                    </label>
                                                                </div>
                                                            </div>
