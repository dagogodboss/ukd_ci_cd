...
<div class="widget-content widget-content-area text-center split-buttons">
                                    ...
                                    <a href="{{url('loan/category/watchful')}}" class="btn btn-primary mb-4 mr-3 btn-lg">Past & Watch</a>
                                    ...
                                    <a href="{{url('loan/category/lost')}}" class="btn btn-danger mb-4 mr-3 btn-lg">Loss</a>
                        ...
                        <tbody>
                            @forelse($loans as $key => $loan)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        {{ Carbon\Carbon::parse($loan->release_date)->diffForHumans() }}
                                    </td>
                                </tr>
                            @empty
