                                    ...
                                    <div id="general-info" class="section general-info">
                                        <div class="info">
                                                    ...
                                                    <div class="col-xl-2 col-lg-12 col-md-4">
                                                        ...
                                                        <div class="col-xl-10 col-lg-12 col-md-8 mt-md-0 mt-4">
                                                           <ul class="nav nav-pills mb-3 mt-3 nav-fill" id="justify-pills-tab" role="tablist">
                                                                <li class="nav-item">
                                                                         <a class="nav-link {{$data->customer->employment->employment_status == 'SELF EMPLOYED' ? 'active' : '' }}">SELF EMPLOYED</a>
                                                                   
                                                                </li>
                                                                <li class="nav-item">
                                                                         <a class="nav-link {{$data->customer->employment->employment_status == 'EMPLOYED' ? 'active' : '' }}">EMPLOYED</a>
                                                                   
                                                                </li>
                                                                <li class="nav-item">
                                                                        <a class="nav-link {{$data->customer->employment->employment_status == 'RETIRED' ? 'active' : '' }}" >RETIRED</a>
                                                                    
                                                                </li>
                                                                <li class="nav-item">
                                                                        <a class="nav-link {{$data->customer->employment->employment_status == 'STUDENT' ? 'active' : '' }}">STUDENT</a>
                                                            ...
                                                            <!-- Start Self Employed -->
                                                                         <div class="tab-pane fade {{$data->customer->employment->employment_status == 'SELF EMPLOYED' ? 'show active' : '' }}" id="justify-pills-home" role="tabpanel" aria-labelledby="justify-pills-home-tab">
                                                            ...
                                                            <!-- Start Employed -->
                                                                            <div class="tab-pane fade {{$data->customer->employment->employment_status == 'EMPLOYED' ? 'show active' : '' }}" id="justify-pills-profile" role="tabpanel" aria-labelledby="justify-pills-profile-tab">
                                          ...
                                          <p>
                                                            ...
                                                            <!-- Start Retired -->
                                                                        <div class="tab-pane fade {{$data->customer->employment->employment_status == 'RETIRED' ? 'show active' : '' }}" id="justify-pills-contact" role="tabpanel" aria-labelledby="justify-pills-contact-tab">
                                                            ...
                                                            <!-- Start Student -->
                                                                @if ($data->customer->employment)
                                                                    <div class="tab-pane fade {{$data->customer->employment->employment_status == 'STUDENT' ? 'show active' : '' }}" id="justify-pills-student" role="tabpanel" aria-labelledby="justify-pills-student-tab">
                                                                @else
