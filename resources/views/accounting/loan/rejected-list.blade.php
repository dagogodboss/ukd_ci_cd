                                    ...
                                    <h6 class="text-center">{{$req->borrower_id}}</h6>
                                     ...
                                     <div class="card">
                                            <div class="card-header" id="headingOne3">
                                                <section class="mb-0 mt-0">
                                                    <div role="menu" class="collapsed" data-toggle="collapse" data-target="#iconAccordionOne{{$req->id}}" aria-expanded="true" aria-controls="iconAccordionOne">
                                                        ...
                                                        Reason for Rejection <div class="icons"><svg xmlns="#" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down"><polyline points="6 9 12 15 18 9"></polyline></svg></div>
                                                    </div>
                                                </section>
                                            </div>
                                            ...
                                            <div id="iconAccordionOne{{$req->id}}" class="collapse" aria-labelledby="headingOne3" data-parent="#iconsAccordion">
                                                <div class="card-body">
                                                    <p class="">
                                                        Click on Re-confirm and click on audit trial to see all the rejection note.
                                                        <!--{{$req->decline_reason}}-->
                                                    </p> 
                                                </div>
                                            </div>
                                        ...
                                        <td class="text-center">
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">
                                                            <a href="{{url('loan/loan/show-request',$req->id)}}" class="badge badge-success" style="float:right;">Re-Confirm</a>
                                                        </div>
                                                    </div>
                                                </td>
                                    </div>
