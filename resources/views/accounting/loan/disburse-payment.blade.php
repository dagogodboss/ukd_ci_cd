         ...
         <div id="tableCheckbox" class="col-lg-12 col-12 layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6">
                                    ...
                                    $total_charge = calPercentageAndDeduction($data->loan_duration_length,$data->insurance_charge,$data->processing_charge,$set_disburse_Amount,7.5);
                                                ...
                                                <td>{{$data->customer->employment->salary_bank_name}}</td>
                                                <td>{{$data->customer->employment->salary_account_number}}</td>
                                                ...
                                                <td width="200">
                                                    @if ($data->loan_disbursed_payment_by)
                                                        <b>{{$data->loan_disbursed_payment_by->first_name}}</b>
                                                        <b>{{$data->loan_disbursed_payment_by->last_name}}</b>
                                                    @endif
                                                </td>
                                                  ...
                                                  @else
                                                    <div class="dropdown custom-dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1" style="will-change: transform;">
                                                            ...
                                                            <a class="dropdown-item text-danger" onClick="setRejectId({{$data->id}})"  data-toggle="modal" data-target="#rejectLoanModal">Pay</a>
                                                        </div>
                                                    </div>
                                                 @endif
                                                </td>
