        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="users" data-parent="#accordionExample">
                    ...
                    <li>
                        <a style="color:{{$_color}}" href="{{url('customer/create')}}"> Create </a>
                    </li>
                     @if(can('Incomplete Registration'))
                    <li>
                        <a style="color:{{$_color}}" href="{{url('customer/view/in-complete-reg')}}"> In Complete Reg </a>
                    </li>
                     @endif
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            ...
                            <li>
                             ...
                             @if(can('View Loan Request Status'))
                                <li>
                                    <a style="color:{{$_color}}" href="{{url('loan/loan/show/request/status')}}"> Request Status</a>
                                </li>
                             @endif
           ...
           @if(can('View Disbursement'))
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="disbursement" data-parent="#accordionExample">
                    ...
                    <li>
                        <a style="color:{{$_color}}" style="color:{{$_color}}" href="{{url('loan/loan/disburse/loan')}}"> Disburse Loan </a>
                    </li>
                    @endif
                     @if(can('Disburse Payment'))
                    <li>
                        <a style="color:{{$_color}}" href="{{url('loan/loan/disburse/loan/payment')}}"> Disburse Payment </a>
                    </li>
                    @endif
            ...
            @endif
             ...
             <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="managepay" data-parent="#accordionExample">
                    <li>
                        <a style="color:{{$_color}}" href="{{url('recovery-history')}}">Monthly Query</a>
                    </li>
                    <li>
